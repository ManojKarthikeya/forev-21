...
export default function ProductPage(props) {
  ...
  const getShoppingBagData = async () => {
    const docRef = doc(db, "spandu&manu", "someUser@gmail.com");
    const docSnap = await getDoc(docRef);
    setShoppingBag(docSnap.data().ShoppingBag);
    setProdIds(docSnap.data().ShoppingBag.map((prod) => prod.productId));
  };
    ...
    setDoc(
      presentDoc,
      {
        ShoppingBag: [
          ...shoppingBag,
          {
            DefaultProductImage: productData.product.DefaultProductImage,
                ...
                <Row>
                  ...
                  <div>
                    ...
                    <div className="d-flex m-4">
                      {props.user ? (
                        prodIds.includes(productData.product.ProductId) ? (
                          <Button
                            onClick={() => {
                              removeFromShoppinBag();
                            }}
                            color="success"
                          >
                            <i class="bi bi-bag mx-2"></i> Remove from Shopping
                            Bag
                          </Button>
                        ) : (
                          <Button
                            ...
                            color="success"
                          >
                            <i class="bi bi-bag mx-2"></i> Add to Shopping Bag
                          </Button>
                        )
                      ) : (
                        <Button
